function main() {
  ...
  const displacementAoiTexture = createTexture(gl, [gl.LINEAR, gl.LINEAR, gl.REPEAT, gl.REPEAT]);
  ...
  const velocityAoiTexture = createTexture(gl, [gl.LINEAR, gl.LINEAR, gl.REPEAT, gl.REPEAT]);
  ...
  const positionAoiTexture = createTexture(gl, [gl.LINEAR, gl.LINEAR, gl.REPEAT, gl.REPEAT]);
  ...
  const outputTexture = createTexture(gl, [gl.LINEAR, gl.LINEAR, gl.REPEAT, gl.REPEAT]);
